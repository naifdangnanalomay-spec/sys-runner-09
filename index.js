    ...
    try {
        ...
        if (interaction.isChatInputCommand()) {
            ...
            if (commandName === 'ticket-setup') {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setDescription('Please select which type of ticket you want to open $ \n\n ➤ – AZURA ORG SUPPORT Support\n ➤ – APPLY FOR STAFF \n ➤ – Public Partnership')

                    .setColor(0x000000)

                    .setImage('https://cdn.discordapp.com/attachments/1397829995908567092/1508712683304783912/fa32ef2b-9939-4806-9495-27ca4803562c.gif?ex=6a1689ae&is=6a15382e&hm=aea71322d2621120d502d427250773bf1b4864b259f3ba06d1429d5e580a9fac');
        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId.startsWith('ticket_')) {
                ...
                return interaction.reply({ content: `Ticket initiated for: ${interaction.customId.replace('ticket_', '')}`, ephemeral: true });
