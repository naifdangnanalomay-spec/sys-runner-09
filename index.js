...
// ✅ Storage para sa mga Warn (Nakaimbak habang naka-on ang bot)
const warns = new Map();
...
Salamat sa pag-apply, babasahin namin agad.`,
            ...
            // ✅ INAYOS NA PARTNERSHIP APPLICATION (TINANGGAL ANG MGA TANONG AT USER ID INFORMATION)
...
Kapag hindi na active o wala na sa galaw — **TANGGALIN KO AGAD** sa listahan.`,
        ...
        if (interaction.isStringSelectMenu()) {
            if (interaction.customId === 'menu_support_options') {
                ...
                // ✅ INAYOS NA ROSTER REGISTRATION (TINANGGAL ANG MGA TANONG AT USER ID INFORMATION)
